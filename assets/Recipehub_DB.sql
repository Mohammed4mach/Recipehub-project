 /*
    ...
    - product [id, userId, name, description,picture, crDate, price, catId, favorites, comments, likes]
...
CREATE TABLE comment
    (
        comm_id INT(9) UNSIGNED PRIMARY KEY,
